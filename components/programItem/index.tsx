  ...
  return (
    <div className="flex basis-1/2 text-left p-5">
      <div className="bg-white flex flex-row content-center">
        <Image
          className="h-[100px] top-1/2 mr-4"
        ...
        <div className="flex flex-col flex-initial">
          ...
          <p className="text-base font-extralight mt-1">{description}</p>
          <a className="text-orange-700 uppercase text-sm font-light mt-1">{link}</a>
        </div>
      </div>
    </div>
  );
